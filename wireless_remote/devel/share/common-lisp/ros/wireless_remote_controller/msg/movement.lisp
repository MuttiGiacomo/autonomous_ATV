...
(cl:in-package wireless_remote_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <movement>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'movement)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wireless_remote_controller-msg:<movement> is deprecated: use wireless_remote_controller-msg:movement instead.")))

(cl:ensure-generic-function 'speed_command-val :lambda-list '(m))
(cl:defmethod speed_command-val ((m <movement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_remote_controller-msg:speed_command-val is deprecated.  Use wireless_remote_controller-msg:speed_command instead.")
  (speed_command m))

(cl:ensure-generic-function 'angle_of_correction-val :lambda-list '(m))
(cl:defmethod angle_of_correction-val ((m <movement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_remote_controller-msg:angle_of_correction-val is deprecated.  Use wireless_remote_controller-msg:angle_of_correction instead.")
...
(cl:defmethod forward_reverse-val ((m <movement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_remote_controller-msg:forward_reverse-val is deprecated.  Use wireless_remote_controller-msg:forward_reverse instead.")
  (forward_reverse m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<movement>)))
  ...
  "wireless_remote_controller/movement")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'movement)))
  "Returns string type for a message object of type 'movement"
  "wireless_remote_controller/movement")
