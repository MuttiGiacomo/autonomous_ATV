...
if("TRUE" STREQUAL "TRUE")
  set(encoder_SOURCE_PREFIX /home/atv-remote/encoder/src/encoder)
  set(encoder_DEVEL_PREFIX /home/atv-remote/encoder/devel)
  set(encoder_INSTALL_PREFIX "")
  set(encoder_PREFIX ${encoder_DEVEL_PREFIX})
else()
  set(encoder_SOURCE_PREFIX "")
  set(encoder_DEVEL_PREFIX "")
  set(encoder_INSTALL_PREFIX /home/atv-remote/encoder/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'atv-test <atv-test@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'encoder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/atv-remote/encoder/src/encoder/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/atv-remote/encoder/devel/lib;/opt/ros/melodic/lib)
